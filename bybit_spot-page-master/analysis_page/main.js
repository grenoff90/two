...
daysLi.forEach((li) => {
    li.addEventListener("click", (e) => {
      daysLi.forEach((li) => {
        ...
        {
          document.querySelector(".three").textContent = '13.91%'
          plChart.data.labels = ['2023-10-09', '', '', '', '', '', '',
          '',
          '',
          '',
          '',
          ...
          plChart.update();
          // profit Chart
          profitChart.data.labels = ['2023-10-09', '', '', '', '', '', '',
          '',
          '',
          '',
          '',
          ...
          profitChart.data.datasets[0].data = [-9.15, 32.3, 28.5, 30, -12, 16, 0,
            0,
            15.7,
            22,
            0,
          ...
          profitChart.update();
          // roichart
          roiChart.data.labels = ['2023-10-09', '', '', '', '', '', '', 
            '',
            '',
            '',
            '',
            ...
            5, 3 , 2
            ,1.94, 2.54, 2.35, 2.96, 3.53, 3.49, 4.3, 4.9 , 6.5, 7.7, 9.03, 8.79, 9.99, 10.73, 11.13, 11.72, 12.29, 12.43, 12.95, 13.55, 14.14, 13.88, 13.91,12.95, 13.55, 14.14,13.55,13.91
            ];
          ...
          profitChart.update();
          // roi chart
          roiChart.data.labels = ['2023-10-14', '', '', '', '', '', '', 
          '',
          '',
          '',
          '',
